    ...
    <div class="user-card">
        <div class="user-card-header">
            <div>
                ...
                <p><?= count($sessions) ?> session(s) active(s)</p>
            </div>
            <?php
            $otherSessions = 0;
            ...
            <?php if ($otherSessions > 0): ?>
                <form method="post" action="/user/security/sessions">
                    ...
                    <button type="submit" class="user-btn user-btn-danger" onclick="return confirm('Déconnecter toutes les autres sessions ?');">
                        ...
                        <div class="user-session-info">
                            ...
                            <?php if (!empty($session->user_agent)): ?>
                                <div class="user-session-agent">
                                    ...
                                    <?= htmlspecialchars((string)$session->user_agent, ENT_QUOTES,'UTF-8') ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
