...
<div class="user-recovery">
    ...
    <div class="user-edit-header">
        ...
        <p>
            Utilisez un code de récupération si vous ne pouvez
            pas accéder à votre application d'authentification.
        </p>
    ...
    <?php if (!empty($recoveryCodes)): ?>
        ...
        <section class="user-security-card">
            ...
            <div class="user-2fa-introduction">
                ...
                <p>
                    Ces codes sont affichés une seule fois.
                    Copiez-les ou imprimez-les avant de quitter cette page.
                </p>
            ...
            <div class="user-recovery-warning">
                ...
                <p>
                    La génération de nouveaux codes invalide
                    immédiatement tous les anciens codes.
                </p>
            ...
            <div class="user-security-action">
                ...
                <div>
                    ...
                    <p>
                        Les codes affichés ci-dessus sont maintenant
                        enregistrés sous forme de hash sécurisé.
                    </p>
        ...
        <section class="user-security-card">
            ...
            <div class="user-security-action">
                ...
                <div>
                    ...
                    <p>
                        Un nouveau jeu de 10 codes remplacera
                        immédiatement les codes actuellement enregistrés.
                    </p>
