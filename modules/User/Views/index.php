...
<div class="user-dashboard">
    <div class="user-dashboard-header">
        <div>
            <span class="user-dashboard-label">Centre utilisateur</span>
            <h1>
                Bienvenue
                <?= htmlspecialchars($user->username ?? 'Utilisateur') ?>
            </h1>
            <p>Gérez votre compte et vos paramètres depuis cet espace.</p>
        </div>
    ...
    <div class="user-dashboard-grid">
        <!-- Profil -->
        <a href="/user/profile" class="user-card">
        ...
        <!-- Modifier -->
        <a href="/user/edit" class="user-card">
            <div class="user-card-icon">✏️</div>
            <div class="user-card-content">
                <h2>Modifier mon profil</h2>
                <p>Modifiez votre nom d'utilisateur et votre adresse email.
                </p>
            </div>
            <span class="user-card-arrow">→</span>
        </a>
        <!-- Sécurité -->
        <a href="/user/security" class="user-card">
            <div class="user-card-icon">🔐</div>
            <div class="user-card-content">
                <h2>Sécurité</h2>
                <p>
        ...
        <!-- Mot de passe -->
        <a href="/user/password" class="user-card">
            <div class="user-card-icon">🔑</div>
            <div class="user-card-content">
                <h2>Mot de passe</h2>
        ...
        <a href="/user/security/sessions" class="user-card">
            ...
            <div class="user-card-content">
                <h2>Mes sessions</h2>
                <p>Gérez vos connexions et vos appareils.</p>
            </div>
            <span class="user-card-arrow">→</span>
        </a>
        <!-- Déconnexion -->
        <a href="/user/logout" class="user-card user-card-danger">
            <div class="user-card-icon">🚪</div>
            <div class="user-card-content">
